...
* DEGs with FDR controlled at 1%: `r num.int(n.fdr01.genes)` genes (`r num.round(100 * n.fdr01.genes / n.tot.genes)`%) consist of `r paste(n.fdr01.celltype.genes, collapse=", ")` across 
